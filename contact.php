...
<head>
    ...
    <link rel="stylesheet" href="css/css/mixins/styles2.css">
...
<body class="goto-here">
    ...
    <nav class="navbar navbar-expand-lg navbar-dark bg-dark ftco_navbar bg_dark ftco-navbar-light" id="fto-navbar">
        <div class="container">
            <a class="navbar-brand" href="index.html">
                <img src="images/PANADERIA OLIMPICA.jpg" width="50" height="50" alt=""></a>
    ...
    <div class="hero-wrap hero-bread" style="background-image: url('images/Clientes.jpg');">
        <div class="container">
    ...
    <section class="ftco-section contact-section bg-light">
        <div class="container">
            <div class="row ">
                    <form action="enviar.html" method="POST" class="bg-white p-5 contact-form">
                        ...
                        <div class="form-group ">
                            <input type="text " name="numeroresidencial" class="form-control " placeholder="Numero residencial " required>
                        </div>
